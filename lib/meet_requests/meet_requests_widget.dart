...
import 'meet_requests_model.dart';
export 'meet_requests_model.dart';

class MeetRequestsWidget extends StatefulWidget {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<ZuhoererRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ZuhoererRecord> meetRequestsZuhoererRecordList = snapshot.data!;
        final meetRequestsZuhoererRecord =
            meetRequestsZuhoererRecordList.isNotEmpty
                ? meetRequestsZuhoererRecordList.first
                : null;
