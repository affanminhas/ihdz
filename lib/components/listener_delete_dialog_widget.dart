...
import 'listener_delete_dialog_model.dart';
export 'listener_delete_dialog_model.dart';

class ListenerDeleteDialogWidget extends StatefulWidget {
  const ListenerDeleteDialogWidget({
    super.key,
    required this.listenerRef,
  });

  final DocumentReference? listenerRef;
                              ...
                              Expanded(
                                child: Padding(
                                  padding: const EdgeInsetsDirectional.fromSTEB(
                                      10.0, 0.0, 0.0, 0.0),
                                  child: Text(
                                    'Mir is bewusst, dass alle Daten unwiederruflich gelöscht werden',
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                          fontFamily: 'Inter',
                                          color: const Color(0xFF8D9294),
                                          letterSpacing: 0.0,
                                        ),
                                  ),
                                ),
                    ...
                    children: [
                      ...
                      FFButtonWidget(
                        ...
                        options: FFButtonOptions(
                          ...
                          borderRadius: BorderRadius.circular(40.0),
                          disabledColor: const Color(0xFF9FA3A7),
                        ),
                      ),
                    ],
                  ),
