...
import 'reg_login_model.dart';
export 'reg_login_model.dart';

class RegLoginWidget extends StatefulWidget {
...
class _RegLoginMaterialState extends State<RegLoginWidget> with TickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RegLoginModel());
    ...
    _model.mobileCreateTextController ??= TextEditingController();
    _model.mobileCreateFocusNode ??= FocusNode();
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  Padding(
                                                    ...
                                                    child: Text(
                                                      'Herzlich Willkommen\n\nBitte melden Sie sich an, oder registrieren sich kostenlos.  Sie benötigen keine Kreditkarte oder andere Zahlungsmethoden.',
                                                    ...
                                                    child: Padding(
                                                      ...
                                                      child: FFButtonWidget(
                                                        onPressed: () async {
                                                          ...
                                                          _model.checkUser = await queryUsersRecordCount(
                                                          ...
                                                          if (_model.checkUser! > 0) {
                                                            ...
                                                            if (currentUserEmailVerified) {
                                                              FFAppState().isListener = false;

                                                              context.goNamedAuth('Zuhoerer', context.mounted);
                                                            } else {
                                                    ...
                                                    children: [
                                                      Align(
                                                        ...
                                                        child: Padding(
                                                          padding: const EdgeInsetsDirectional.fromSTEB(
                                                              0.0, 12.0, 0.0, 24.0),
                                                          child: Text(
                                                            'Starten Sie Ihre kostenlose Anmeldung ',
                                                            style: FlutterFlowTheme.of(context).labelMedium.override(
                                                                  fontFamily: 'Inter',
                                                                  color: Colors.white,
                                                                  letterSpacing: 0.0,
                                                      ...
                                                      Padding(
                                                        ...
                                                        child: SizedBox(
                                                          width: double.infinity,
                                                          child: TextFormField(
                                                            controller: _model.mobileCreateTextController,
                                                            focusNode: _model.mobileCreateFocusNode,
                                                            onChanged: (_) => EasyDebounce.debounce(
                                                              '_model.mobileCreateTextController',
                                                              const Duration(milliseconds: 100),
                                                              () async {
                                                                FFAppState().notificationPhoneNumber =
                                                                    _model.mobileCreateTextController.text;
                                                                safeSetState(() {});
                                                              },
                                                            ),
                                                            autofocus: true,
                                                            ...
                                                            cursorColor: FlutterFlowTheme.of(context).secondary,
                                                            validator: _model.mobileCreateTextControllerValidator
                                                                .asValidator(context),
                                                          ),
                                                        ),
                                                      ),
