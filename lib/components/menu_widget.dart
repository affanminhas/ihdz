            ...
            Align(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    padding:
                        const EdgeInsetsDirectional.fromSTEB(18.0, 160.0, 18.0, 0.0),
                    child: InkWell(
                      splashColor: Colors.transparent,
                      focusColor: Colors.transparent,
                      hoverColor: Colors.transparent,
                      highlightColor: Colors.transparent,
                      onTap: () async {
                        context.pushNamed('Bedienungsanleitung');
                      },
                      child: Container(
                        width: double.infinity,
                        height: 50.0,
                  ...
                  Padding(
                    padding:
                        const EdgeInsetsDirectional.fromSTEB(18.0, 10.0, 18.0, 50.0),
                    child: InkWell(
                      splashColor: Colors.transparent,
                      focusColor: Colors.transparent,
                      hoverColor: Colors.transparent,
                      highlightColor: Colors.transparent,
                      onTap: () async {
                        context.pushNamed('RegelnNutzer');
                      },
                      child: Container(
                        width: double.infinity,
                        height: 50.0,
                    ...
                    Align(
                      ...
                      child: Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            context.pushNamed('RegLoginZuhoerer');
                          },
                          text: 'Anmelden ZuHörer',
