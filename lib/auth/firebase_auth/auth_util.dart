...
DocumentReference? get currentUserReference => loggedIn
    ? PushNotificationUsersRecord.collection.doc(currentUser!.uid)
    : null;

PushNotificationUsersRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : PushNotificationUsersRecord.getDocument(
                  PushNotificationUsersRecord.collection.doc(uid))
              .handleError((_) {}),
    )
    .map((user) {
