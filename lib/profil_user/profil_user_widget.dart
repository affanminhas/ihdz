  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<UsersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRecord> profilUserUsersRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final profilUserUsersRecord = profilUserUsersRecordList.isNotEmpty
            ? profilUserUsersRecordList.first
            : null;
                    ...
                    image: DecorationImage(
                      ...
                      image: Image.network(
                        valueOrDefault<String>(
                          profilUserUsersRecord?.photoUrl,
                      ...
                      children: [
                                    ...
                                    child: Padding(
                                      ...
                                      child: TextFormField(
                                        controller: _model.textController2 ??=
                                            TextEditingController(
                                          text: profilUserUsersRecord?.email,
                                        ),
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              await profilUserUsersRecord!.reference
